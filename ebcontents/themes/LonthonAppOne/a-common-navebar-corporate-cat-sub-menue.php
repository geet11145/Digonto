...
<li> <a href='<?php echo outCorporateLink; ?>/project/' class='dropdown-toggle' data-toggle='dropdown'><i class='fa fa-briefcase fa-lg' aria-hidden='true'></i> Projects<b class='caret'></b></a>
<ul class='dropdown-menu multi-level'>
<li><a href='<?php echo outCorporateLink; ?>/project/' title='Projects View'><i class='fa fa-briefcase fa-lg' aria-hidden='true'></i> Projects</a></li>
