...
<li class='dropdown'> <a href='<?php echo outCorporateLink; ?>/project/' class='dropdown-toggle' data-toggle='dropdown'><?php echo ucfirst($category->visulString($project_category)); ?> <b class='caret'></b></a>
