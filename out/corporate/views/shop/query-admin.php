...
$user->submit_project_query_mini_merchant($eb_corporates_id_in_comments,$eb_corporates_comment_details);
}
}
?>
<?php
...
$queryMe .="<div class='buttons-set'><button type='submit' name='project_submit_query' title='Reply' class='button submit'><span> Reply </span> </button></div>"; 
$queryMe .="</fieldset>";
$queryMe .="</form>";
echo $queryMe;
