<?php $obj= new ebapps\corporate\corporate(); $obj -> project_carousel_sub_category($projectCategory, $projectSubCategory); ?>
<?php if($obj->data > 0) { ?>
<div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container'>
<div id='rev_slider_4' class='rev_slider fullwidthabanner'>
<ul>
<?php foreach($obj->data as $val): extract($val); ?>
<li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?php echo hypertextWithOrWithoutWww.$project_og_image_url; ?>'><img src='<?php echo hypertextWithOrWithoutWww.$project_og_image_url; ?>' alt='<?php echo ucfirst($obj->visulString($project_og_image_title)); ?>' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' />
<div class='info'>
...
<div class='tp-caption sfb tp-resizeme' data-endspeed='500' data-speed='500' data-start='1500' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1'><a href='<?php echo outCorporateLink; ?>/project/details/<?php echo $project_id; ?>/<?php echo $project_category; ?>/<?php echo $project_sub_category; ?>/' class='buy-btn eBTextBack'>Details</a></div>
</div>
</li>
<?php endforeach;  ?>
</ul>
