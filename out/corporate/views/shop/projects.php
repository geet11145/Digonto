...
<!-- Category -->
<?php $obj= new ebapps\corporate\corporate(); $obj -> project_thurmnail_all(); ?>
<?php if($obj->data){ foreach($obj->data as $val): extract($val); ?> 
<button class='eb-filter-back filter-button' data-filter='<?php echo $project_category; ?>'><?php echo ucfirst($obj->visulString($project_category)); ?> </button>
<?php endforeach; ?>
<?php } ?>
</div>
</div>
<div class='row'>
<?php $obj= new ebapps\corporate\corporate(); $obj -> project_project_all_sub_category(); ?>
<?php if($obj->data){ foreach($obj->data as $val): extract($val); ?> 
<div class='col-md-3 filter filterContent <?php echo $project_category; ?>'>
...
<div class='cap1'>
<h3 title='<?php echo ucfirst($project_sub_category); ?>'><?php echo ucfirst($obj->visulString($project_sub_category)); ?></h3>
<p><a class='eb-filter-back' href='<?php echo outCorporateLink; ?>/project/category/<?php echo $project_id; ?>/' role='button'><?php echo ucfirst($obj->visulString($project_sub_category)); ?></a></p>
</div>
<div class='cap2'>
