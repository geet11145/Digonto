...
$newSearch .="<div class='item-title'><h2>".ucfirst($project_og_image_title)."</h2></div>";
$newSearch .="<div class='item-title'><h3>".strtoupper($searchobj->visulString($project_sub_category))."</h3></div>";
$newSearch .="<div class='item-img'>";
$newSearch .="<div class='item-img-info'><a class='product-image' title='$project_og_image_title' href='";
$newSearch .=outCorporateLink."/project/solve/$project_id/".$searchobj->seoUrl($project_og_image_title)."/";
$newSearch .="'><img alt='$project_og_image_title' src='";
...
$newSearch .="<a href='";
$newSearch .=outCorporateLink."/project/solve/$project_id/".$searchobj->seoUrl($project_og_image_title)."/";
$newSearch .="'><button class='button btn-cart' type='button' title='Read More' data-original-title='$project_og_image_title'><span>Read More</span></button></a>";
$newSearch .="</div>";
